...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed z-40">
      ...
      `}
      >
        <img className="h4-4 lg:h-7" src="/images/logo.png" alt="Logo" />
        <div className="
        flex-row
        ml-8
        gap-7
        ...
        <div onClick={toggleMobileMenu} className="lg:hidden flex flex-flow items-center gap-2 ml-8 cursor-pointer relative
        ">
        ...
        <div className="flex flex-row ml-auto gap-7 items-center">
          ...
          <div onClick={toggleShowAccountMenu} className="flex flex-row items-center gap-2 cursor-pointer relative">
            <div className="w-6 h-6 lg:w-10 lg:h-10 rounded-md overflow-hidden">
              <img src="/images/default-red.png" alt="user" />
            </div>
